      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mb-6">
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              {/* Encabezado del modal con color del proyecto */}
              <div 
              ...
              <div className="p-8">
                ...
                {/* Restaurar project button - centered at the bottom */}
                {/* Zoom Meeting Section for archived projects - Consistent with active projects */}
