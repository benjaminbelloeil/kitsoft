// app/dashboard/proyectos/archivados/page.tsx
'use client';
          ...
          >
            ...
            <div className="p-6">
                  ...
                  {selectedProject.tasks.map((task: any) => (
                    ...
                    >
                      <div className="flex items-start">
                        <div className="mt-0.5 w-5 h-5 rounded-full flex-shrink-0 mr-3 flex items-center justify-center bg-green-500">
              ...
              <div className="mt-8 pt-6 border-t">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Cargabilidad actual:</span>
