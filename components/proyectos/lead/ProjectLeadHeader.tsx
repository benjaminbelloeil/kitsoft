          ...
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3 text-sm">
                ...
                <div className="px-3 py-2 bg-blue-50 rounded-md border border-blue-100 shadow-sm transition-all hover:shadow-md hover:border-blue-200">
                  <span className="text-blue-700">Usuarios Asignados:</span>
                  <span className="ml-1 font-semibold text-blue-800">{assignedUsers}</span>
                </div>
              </div>
