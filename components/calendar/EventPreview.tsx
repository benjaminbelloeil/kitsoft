    ...
    >
      ...
      <div className="p-4 space-y-3 overflow-y-auto" style={{ maxHeight: '300px' }}>
        ...
        <div className="flex gap-2 pt-2 mt-4">
          <button className="flex-1 px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 fast-transition text-sm">
            Editar
          </button>
          <button className="flex-1 px-4 py-2 bg-red-50 text-red-600 rounded-md hover:bg-red-100 fast-transition text-sm">
            Cancelar
          </button>
        </div>
      </div>
